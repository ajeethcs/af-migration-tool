...
ALLOFACTORSERVICE_SRC = ALLOFACTORSERVICE_PATH / \
    "src" / "com" / "iris" / "allofactor"
...
CALL_GRAPHS_DIR.mkdir(parents=True, exist_ok=True)
CONVERTED_CODE_DIR.mkdir(parents=True, exist_ok=True)
